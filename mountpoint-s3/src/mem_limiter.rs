...
impl<Client: ObjectClient> MemoryLimiter<Client> {
    ...
    pub fn try_reserve(&self, size: u64) -> bool {
        ...
        loop {
            ...
            let client_mem_reserved = self.client_mem_reserved();
            let new_total_mem_usage = new_prefetcher_mem_reserved
                .saturating_add(client_mem_reserved)
    ...
    pub fn available_mem(&self) -> u64 {
        ...
        self.mem_limit
            ...
            .saturating_sub(client_mem_reserved)
            .saturating_sub(self.additional_mem_reserved)
    }

    fn client_mem_reserved(&self) -> u64 {
        self.client.mem_usage_stats().map_or(0, |stats| stats.mem_reserved)
    }
}
